        ...
        var execFunction = function () {
            if (level.player.isReady()) {
                ...
                if (!action) {
                    ...
                    field.execLock = false;

                    if (this.td) {
                        if (this.hasClass) {
                            this.td.setAttribute("class", this.oldClass);
                        } else {
                    ...
                    this.hasClass = td.hasAttribute("class");
                    this.oldClass = td.getAttribute("class");
                    if (this.hasClass) {
                        this.td.setAttribute("class", oldClass + " currentAction");
                    } else {
                        this.td.setAttribute("class", "currentAction");
                    }
