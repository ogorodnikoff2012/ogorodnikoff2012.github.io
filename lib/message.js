/**Этот объект предоставляет функции для вывода различных сообщений
 * */
var message = {};

/**Вывод сообщения о завершении программы. Есть кнопки перехода в гланое меню, на следующий уровень.
 * @param flag - выполнена ли миссия
 * */
 ...
 * @param cnumber - номер команды, на которой произошла ошибка
 ...
 * @param okFunction - действие после нажатия на кнопку OK
 * @param cancelFunction - действие после нажатия на кнопку Cancel*/
