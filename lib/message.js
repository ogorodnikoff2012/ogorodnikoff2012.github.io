...
message.endOfProgram = function(flag) {
	...
	menuButton.innerText = i18n.translate("Go to main menu");
    ...
    if(levelManager.getNextLevel() && flag) {
        ...
        nextLevelButton.innerText = i18n.translate("Next level");
    ...
    retryButton.innerText = i18n.translate("Retry");
...
message.badProgram = function(cnumber, message) {
    ...
    okButton.innerText = i18n.translate("OK");
...
message.confirm = function(text, okFunction, cancelFunction) {
    ...
    cancelButton.innerText = i18n.translate("Cancel");
    cancelButton.onclick = (function(message) {
        return function() {
            message.hideDialog();
            message.clearDialog();
            if(cancelFunction) {
